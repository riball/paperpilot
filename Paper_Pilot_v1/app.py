...
# ---------------------------------------------------------------------------
# CORS — reads allowed origins from .env so you don't have to touch this file
# In production .env, set:
#   ALLOWED_ORIGINS=https://your-app.vercel.app,https://your-other-domain.com
# For local dev, leave it unset and it defaults to localhost:5173
# ---------------------------------------------------------------------------
